...
class InstructorDaoTest extends AbstractTest {
    ...
    void testFindInstructorsByEmail() {
        ...
        Instructor instructor = instructorDao.findInstructorsByEmail("instructorUser1@gmail.com");
        assertEquals(expectedInstructor, instructor);
    }

    @Test
    void testFindInstructorByNotExistingEmail() {
        Instructor instructor = instructorDao.findInstructorsByEmail("javacorner@gmail.com");
